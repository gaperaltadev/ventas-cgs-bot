...
const FLOW_COMMANDS = new Set([
  // Legacy (flujo texto plano — mantener mientras coexiste con el interactivo)
  '__select__',
  '__pedido_buscar_cliente__',
  '__pedido_alta_cliente__',
  '__pedido_items__',
  '__pedido_confirmar__',
  // Nuevos comandos de flujo interactivo (texto libre)
  '__pedido_alta_nombre__',
  '__pedido_esperando_item__',
  '__pedido_esperando_cantidad__',
  // Flujo interactivo (botones y listas)
